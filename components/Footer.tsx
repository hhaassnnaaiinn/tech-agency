      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400 mb-4">TechAgency</h3>
            <p className="text-gray-300 mb-4 max-w-md">
              We are a leading technology agency specializing in innovative digital solutions, 
              web development, and cutting-edge technology consulting.
            </p>
